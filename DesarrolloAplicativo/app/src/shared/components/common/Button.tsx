...
import { useColors } from '../../../app/providers/ThemeContext'; // Importa useColors: hook que retorna los colores del tema activo (claro/oscuro + acento) — de app/state/ThemeContext.tsx
