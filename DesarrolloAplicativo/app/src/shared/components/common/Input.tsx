...
import { useColors } from '../../../app/providers/ThemeContext'; // Importa useColors: hook que retorna los colores del tema actual (claro/oscuro) — de app/state/ThemeContext.tsx
