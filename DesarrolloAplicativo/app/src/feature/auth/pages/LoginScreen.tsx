...
import { Input } from '../../../shared/components/common/Input'; // Componente reutilizable de campo de texto con íconos y errores — ruta: app/presentation/components/common/Input.tsx
